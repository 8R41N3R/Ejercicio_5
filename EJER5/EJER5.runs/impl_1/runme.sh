...
HD_PWD='D:/VIVADO/EJER5/Ejercicio_5/EJER5/EJER5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log param_full_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source param_full_adder.tcl -notrace
