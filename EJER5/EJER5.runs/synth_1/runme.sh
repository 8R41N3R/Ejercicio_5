...
HD_PWD='D:/VIVADO/EJER5/Ejercicio_5/EJER5/EJER5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log param_full_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source param_full_adder.tcl
